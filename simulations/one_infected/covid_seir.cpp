...
int main()
{
	...
	// Input files
	std::string fin("input_data/NR_agents_seir.txt");
	std::string hfile("input_data/NR_households_seir.txt");
	std::string sfile("input_data/NR_schools_seir.txt");
	std::string wfile("input_data/NR_workplaces_seir.txt");
